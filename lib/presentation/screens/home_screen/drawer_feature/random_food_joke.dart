...
class RandomFoodJoke extends StatefulWidget {
  RandomFoodJoke({super.key, required this.name});
  String name;

  @override
  State<RandomFoodJoke> createState() => _RandomFoodJokeState();
}

class _RandomFoodJokeState extends State<RandomFoodJoke> {
  @override
          ...
          children: [
            ...
            Center(
              child: Column(
                ...
                children: [
                  Text("Random Food Joke",style: TextStyle(fontSize: 36),),
